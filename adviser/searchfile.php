<?php
    ...
    if(isset($_POST['input'])){
        ...
        if(!empty($input)){
            ...
            WHERE research_documents.adviser='$adviser' AND research_documents.status<>'Published' AND research_documents.status<>'Pending' AND research_documents.instatus<>'inactive'
