<?php 
  ...
  if(isset($_SESSION['account_adviser'])){
      $name = $_SESSION['account_adviser'];
      $id = $_SESSION['idaccount_adviser'];
      $logout_id = $_SESSION['adviser_unique_id'];
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link nav-hov <?php if($title == "Pending"){echo "active";} ?>" href="pending.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link nav-hov <?php if($title == "Checked Files"){echo "active";} ?>" href="archive.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
