<?php
    ...
    if(isset($_POST['input'])){
        ...
        if(!empty($input)){
            ...
            AND (research_documents.research_title LIKE '%{$input}%' OR research_documents.authors LIKE '%{$input}%' OR research_documents.type_r LIKE '%{$input}%' 
            OR research_documents.chapter LIKE '%{$input}%' 
