                                        ...
                                        <div class="row form-group">
                                            <div class="col-sm-12">
                                                <div class='btn-group d-flex' role='group' style='overflow: auto;'>
                                                    <a href="
                                                        <?php
                                                            if(isset($_SESSION['backpage_ad'])){
                                                                $backpage = $_SESSION['backpage_ad'];
                                                                if($backpage == "pending.php"){
                                                                    echo "pending.php";
                                                                }
                                                                if($backpage == "archive.php"){
                                                                    echo "archive.php";
                                                                }
                                                            }
                                                    ...
                                                    <a href="comments.php?fileid=<?php echo $fileid; ?>" class="btn btn-light"><i class="fa fa-comment"></i> Additional Comment</a>
                                                    <a href="check.php?fileid=<?php echo $fileid; ?>" class="btn btn-light"><i class="fa fa-check"></i> Check Research</a>
                                                </div>
                                            </div>
                                        </div>
