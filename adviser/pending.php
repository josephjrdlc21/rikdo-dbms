<?php 
    ...
    $_SESSION['backpage_ad'] = "pending.php";
    ...
    $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM research_documents WHERE adviser='$adviser' AND status='Pending' AND instatus<>'inactive'");
