<?php
  $title = "Senior High Research";
  require_once "db.php"; 
  include_once 'header.php';

  $_SESSION['backpage_hub'] = "shs.php";
  ...
  WHERE users.role='Senior High School' AND research_documents.status='Published' AND published_research.document=research_documents.id AND research_documents.submitted_by=users.id");
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-12 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Senior High School Research</h1>
