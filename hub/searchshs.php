<?php
    ...
    if(isset($_POST['input'])){
        ...
        WHERE users.role='Senior High School' AND research_documents.status='Published' AND published_research.document=research_documents.id AND research_documents.submitted_by=users.id AND research_documents.research_title LIKE '%{$input}%'
