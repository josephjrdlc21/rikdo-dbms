                                            ...
                                            <div class="card-body">
                                                <?php
                                                    ...
                                                    if (mysqli_num_rows($show_comment_file) > 0) {
                                                        while($row_comment_file = mysqli_fetch_assoc($show_comment_file)) {
                                                ?>
                                                        <div class="d-flex flex-start align-items-center">
                                                            <img class="rounded-circle shadow-1-strong me-3"
                                                            src="../profile/<?php echo $row_comment_file["profile"];?>" alt="avatar" width="60"
                                                            height="60" />
                                                            <div>
                                                                <h6 class="fw-bold mb-1"><?php echo $row_comment_file["firstname"] . " " . $row_comment_file["lastname"];?></h6>
