<?php 
  ...
  if(isset($_SESSION['account_admin'])){
      $name = $_SESSION['account_admin'];
      $id = $_SESSION['idaccount_admin'];
      $logout_id = $_SESSION['admin_unique_id'];
...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link nav-hov <?php if($title == "Dashboard"){echo "active";} ?>" href="admin_dashboard.php">
        ...
        <li class="nav-item">
          <a class="nav-link nav-hov <?php if($title == "Journal"){echo "active";} ?>" href="admin_journal.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-book text-warning text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Completed Research</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link nav-hov <?php if($title == "Pending"){echo "active";} ?>" href="admin_submitted.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-clone text-success text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Pending Files</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link nav-hov <?php if($title == "Checked Files"){echo "active";} ?>" href="admin_archive.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa fa-folder text-sm opacity-10" style="color: #9999ff"></i>
            </div>
            <span class="nav-link-text ms-1">Checked Files</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link nav-hov <?php if($title == "File Cabinet"){echo "active";} ?>" href="admin_cabinet.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-folder-17 text-secondary text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">File Cabinet</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link nav-hov <?php if($title == "Archive"){echo "active";} ?>" href="admin_arc.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link nav-hov <?php if($title == "Reports"){echo "active";} ?>" href="admin_report.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa fa-file text-danger text-sm opacity-10"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link nav-hov <?php if($title == "My Profile"){echo "active";} ?>" href="admin_profile.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link nav-hov <?php if($title == "Users"){echo "active";} ?>" href="users.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link nav-hov <?php if($title == "Account Log"){echo "active";} ?>" href="admin_account_log.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-desktop text-dark text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Account Log</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link nav-hov <?php if($title == "Activity Log"){echo "active";} ?>" href="activitylog.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="admin_profile.php" class="nav-link text-white font-weight-bold px-0">
                <img src="../profile/<?php if(!empty($profile)){echo $profile;} ?>" style="margin-right: 10px;" class="shadow rounded-circle" alt="profile" height="40px" width="40px">
