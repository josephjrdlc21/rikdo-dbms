<?php 
    ...
    if(isset($_GET['fileid'])){
        ...
        $instatus = $row_edit_file ['instatus'];
    ...
    if(isset($_GET['fileid']) && isset($_GET['restore'])){
        $fileid = $_GET['fileid'];
        $restore = $_GET['restore'];

        $sql_update_research = mysqli_query($conn,"UPDATE research_documents SET instatus='$restore' WHERE id='$fileid'");

        if($sql_update_research){
            echo "<script>swal({title: 'Research Restored', text: 'Research has been restored successfully!', icon: 
    ...
    <div class="container py-4">
        <div class="row">
            <div class="col-lg grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-primary">Researchers File</h4>
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12" >
                                <div class="shadow-lg card card-plain mb-4">
                                    ...
                                    <form method="POST">
                                                    ...
                                                    <a href="
                                                        <?php
                                                            if(isset($_SESSION['backpage'])){
                                                                ...
                                                                if($backpage == "admin_arc.php"){
                                                                    echo $backpage;
                                                                }
                                                                if($backpage == "admin_submitted.php"){
                                                                    echo $backpage;
                                                                }
                                                                if($backpage == "admin_cabinet.php"){
                                                                    echo $backpage;
                                                                }
                                                                if($backpage == "admin_archive.php"){
                                                                    echo $backpage;
                                                                }
                                                            }
                                                    ?>
                                                    " class="btn btn-light"><i class="fas fa-reply"></i> Back</a>
                                                    <a href="download.php?files=<?php echo $filename?>&&id=<?php echo $fileid?>" class="btn btn-light <?php if($instatus == "inactive"){ echo "disabled";} ?>"><i class="fa fa-download"></i> Download to open</a>
                                                    <a href="comments.php?fileid=<?php echo $fileid; ?>" class="btn btn-light <?php if($instatus == "inactive" || $adviser != $_SESSION['idaccount_admin']){ echo "disabled";} ?>"><i class="fa fa-comment"></i> Additional Comment</a>
                                                    <a href="check.php?fileid=<?php echo $fileid; ?>" class="btn btn-light <?php if($instatus == "inactive" || $adviser != $_SESSION['idaccount_admin']){ echo "disabled";} ?>"><i class="fa fa-check"></i> Check Research</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <?php 
                                            if($instatus == "inactive"){
                                                echo "<a class='btn btn-dark w-100 mt-2' href='?fileid=$fileid&&restore=active'>Restore Research</a>";
                                            }
                                        ?>
                                    </form>
                                    </div>
