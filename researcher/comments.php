                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card card-plain mt-4">
                                            ...
                                            <form method="POST">
                                                ...
                                                <input type="hidden" name="editor_content" contenteditable="false">
                                                <br>
                                                <a href="view_file.php?fileid=<?php echo $fileid; ?>" class="btn btn-light btn-sm" style="float: right;">Cancel</a>
                                                <button type="submit" name="submit" class="btn btn-dark btn-sm" style="float: right; margin-right: 5px;" disabled>Post comment</button>
                                            </form>
                                        </div>
