<?php 
  ...
  $researcherid = $_SESSION['idaccount_researcher'];

  $total_research_check = mysqli_query($conn,
  "SELECT * FROM research_documents WHERE submitted_by='$researcherid' AND instatus='active' AND (status='Approved' OR status='Revision' OR status='Rejected' OR status='Pending')");
              ...
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <p class="mb-0">
                      <a href="research.php" class="text-primary text-sm font-weight-bolder">View More <i class="fa fa-arrow-circle-right"></i></a>
                    </p>
                  </div>
                </div>
              ...
              <canvas id="myChart2"></canvas>
                  <?php
                    ...
                    foreach ($research_statuses as $research_status) {
                        ...
                        "SELECT * FROM research_documents WHERE submitted_by='$researcherid' AND instatus='active' AND status='$research_status'");
